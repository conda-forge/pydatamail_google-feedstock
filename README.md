About pydatamail_google-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pydatamail_google-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pydatamail_google-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pydatamail_google
# for installing globally
pixi global install pydatamail_google
```
...
It is possible to list all of the versions of `pydatamail_google` available on your platform:
...
```
pixi search pydatamail_google --channel conda-forge
```
